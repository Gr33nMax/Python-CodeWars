...
def is_valid_walk(walk: iter) -> bool:
    return len(walk) == 10 and (walk.count('n') == walk.count('s') and walk.count('w') == walk.count('e'))


assert is_valid_walk(['n', 's', 'n', 's', 'n', 's', 'n', 's', 'n', 's']), 'should return True'
assert not is_valid_walk(['w', 'e', 'w', 'e', 'w', 'e', 'w', 'e', 'w', 'e', 'w', 'e']), 'should return False'
assert not is_valid_walk(['w']), 'should return False'
assert not is_valid_walk(['n', 'n', 'n', 'ss', 'n', 's', 'n', 's', 'n', 's']), 'should return False'
